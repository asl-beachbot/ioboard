#ifndef _ROS_localization_scan_point_h
#define _ROS_localization_scan_point_h
...
namespace localization
{
  ...
  class scan_point : public ros::Msg
  {
    public:
      float distance;
      float angle;
    ...
    const char * getType(){ return "localization/scan_point"; };
